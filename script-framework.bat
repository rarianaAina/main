...
REM Déclaration des variables
    ...
    set temp=D:\ITU\MrNaina\Sprint15\test\%nom_projet%
    set lib=D:\ITU\MrNaina\Sprint15\test\lib
    set lib-framework=D:\ITU\MrNaina\Sprint15\main\lib
    set src=D:\ITU\MrNaina\Sprint15\main\src
